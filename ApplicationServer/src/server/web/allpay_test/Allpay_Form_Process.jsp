...
System.out.println("交易編號 : "+trade_no);
...
//9. 回傳網址 Varchar(200) 當消費者付款完成後，會將付款結果回傳到該網址。 
  //  String return_url = "http://www.allpay.com.tw/receive.php";
      String return_url = "http://219.85.221.13:8080/src/server/web/allpay_test/Allpay_Form_ReturnURL.jsp";
// String return_url="google.com";
...
//      String client_back_url = "http://54.69.109.145/allpay_test/echo.jsp";
...
//    String orderResultURL = "http://www.allpay.com.tw/client.php";
    String orderResultURL = "http://219.85.221.13:8080/TradeResult";
...
<form name="myform" method="post" action="https://payment.allpay.com.tw/Cashier/AioCheckOut"  enctype = "application/x-www-form-urlencoded">
        ...
        <b>7. CheckMacValue </b><br>
            -->
            7.MerchantID:<input type='text' name='MerchantID' value="<% out.print(merchant_id);%>"><br><br>
            8.OrderResultURL:<input type='text' name='OrderResultURL' value="<% out.print(orderResultURL);%>"><br><br>
            9.ReturnURL:<input type='text' name='ReturnURL' value="<% out.print(return_url);%>"><br><br>
            10.PaymentType:<input type='text' name='PaymentType' value="<% out.print(payment_type);%>"><br><br>
            11.ClientBackURL:<input type='text' name='ClientBackURL' value="<% out.print(client_back_url);%>"><br><br>  
            12.CheckMacValue:<input type="hidden" name="CheckMacValue" value="<% out.print(CheckMacValue);%>" readonly="readonly"> <br><br>
