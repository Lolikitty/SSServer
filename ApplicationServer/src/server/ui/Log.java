...
class Logger {
    ...
    public Logger(LogDB log, String context) {
        this.log = log;
...
public class Log {
    ...
    public Log() {
        ...
        layout.getStylesheets().add(UIRoot.class.getResource("Log.css").toExternalForm());
    ...
    public static void printDebug(String className, String msg) {
    ...
    public static void printInfo(String className, String msg) {
    ...
    public static void printWarn(String className, String msg) {
    ...
    public static void printError(String className, String msg) {
